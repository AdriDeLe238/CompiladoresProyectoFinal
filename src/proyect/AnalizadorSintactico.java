...
public class AnalizadorSintactico {
    ...
    public Nodo tipo() {
        ...
        switch (this.actual.tipoToken) {
            ...
            case "bool":
                ...
                break;
            default:
                syntaxError("Hubo un error en tipo ");
                break;
        }
        return n;
    }
    ...
    public Nodo lista_sentencia() {
        ...
        while ("if".equals(this.actual.tipoToken) || "while".equals(this.actual.tipoToken) || "do".equals(this.actual.tipoToken)
                ...
                || "Identificador".equals(this.actual.getToken())) {
            System.out.println("d" + this.actual.tipoToken);
            if (n == null) {
                n = sentencia();
                sig = n;
            } else {
    ...
    public Nodo sentencia() {
        ...
        switch (this.actual.tipoToken) {
            ...
            case "{":
                ...
                break;
            default:
                if (this.actual.getToken().equals("Identificador")) {
                    n = asignacion();
                } else {
                    syntaxError("Hubo un error ");
                }
    ...
    public Nodo sent_write() {
        Nodo n = new Nodo(this.actual);
        match("write"); //hasta aqui si esta bien 
        n.hijos[0] = b_expresion();
        match(";");
        return n;
    }
